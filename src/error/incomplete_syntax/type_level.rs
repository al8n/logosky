//! Type-level capacity syntax and incomplete syntax error implementation.
//!
//! This implementation uses `generic_array` and `typenum` to specify the number
//! of components at the type level. This enables type-level arithmetic on component
//! counts and better integration with generic-array-based APIs.
...
/// use logosky::utils::{syntax::{Syntax, IncompleteSyntax}, typenum};
/// use typenum::U3;
/// use core::fmt;
///
