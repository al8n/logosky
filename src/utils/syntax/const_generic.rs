...
/// A trait representing a syntax with a fixed number of components.
///
/// This trait defines the structure of a syntax element that has a known number
/// of required components. It's used for error reporting when parsing incomplete
/// syntax constructs.
///
/// # Type Parameters
///
/// - `Component`: The type representing individual syntax components (usually an enum)
/// - `COMPONENTS`: The total number of possible components (const generic)
///
/// # Examples
///
/// ```rust
/// use logosky::utils::syntax::Syntax;
/// use core::fmt;
///
...
///
///     fn possible_components() -> [Self::Component; Self::COMPONENTS] {
///         [
...
pub trait Syntax {
  ...
  /// The number of components in this syntax.
  ///
  /// This constant defines how many distinct components make up a complete syntax element.
