...
/// }
/// ```
pub struct TokenStream<'a, T: Token<'a>, L: Lexer<'a, T>, C = ()> {
...
impl<'a, T, L, C> Clone for TokenStream<'a, T, L, C>
where
  T: Token<'a>,
  L: Lexer<'a, T>,
  L::State: Clone,
...
impl<'a, T, L, C> core::fmt::Debug for TokenStream<'a, T, L, C>
where
  T: Token<'a>,
...
impl<'a, T, L, C> TokenStream<'a, T, L, C>
where
  T: Token<'a>,
  L: Lexer<'a, T>,
{
